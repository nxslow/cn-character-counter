...
function testCharacterCounter() {
    ...
    const pos3 = findLastValidCharPosition(testText3, 6); // 查找第6个有效字符
    console.log('测试3 - 查找字符位置:');
    console.log('输入:', testText3);
    console.log('第6个字符位置:', pos3, '字符:', testText3[pos3]);
    console.log('预期: 位置7, 字符 ","');
    console.log('测试结果:', pos3 === 7 && testText3[pos3] === ',' ? '✓ 通过' : '✗ 失败');
}
